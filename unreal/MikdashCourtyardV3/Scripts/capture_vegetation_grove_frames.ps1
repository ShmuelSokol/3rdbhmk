...
$views = @(
    @{ name = 'grove-leaf-7m';      go = '25100 -43450 -2140 5 12 0' },
    @{ name = 'grove-midrange-25m'; go = '23000 -43474 -2120 3 0 0' },
    @{ name = 'grove-palm-30m';     go = '23200 -43700 -2150 18 10 0' },
    @{ name = 'grove-above-canopy'; go = '22000 -43474 -1100 -8 0 0' }
)
