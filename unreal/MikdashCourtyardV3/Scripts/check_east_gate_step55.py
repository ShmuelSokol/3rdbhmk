...
output = root/'SourceAssets/runtime-review/east-gate-step55-trial.json'
output.parent.mkdir(parents=True, exist_ok=True)
report = {'status':'running', 'scope':'Synthetic continuous CharacterMovement down/up east gate stairs; no teleport; not physical keyboard or packaged acceptance', 'samples':[], 'reached':[], 'errors':[]}
...
def tick(delta):
    ...
    try:
        ...
        if not (1900 < pos.x < 5200 and abs(pos.y) < 200 and 250 < pos.z < 800):
        ...
        report['trialMaxStepHeightCm']=movement.get_editor_property('max_step_height')
