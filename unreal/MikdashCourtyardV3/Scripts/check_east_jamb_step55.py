...
output=root/'SourceAssets/runtime-review/east-jamb-step55-trial.json'
...
def tick(delta):
 ...
 try:
  ...
  cm.set_editor_property('max_step_height',55.0)
  r['trialMaxStepHeightCm']=cm.get_editor_property('max_step_height')
