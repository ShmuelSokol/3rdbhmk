param([ValidateRange(30,1800)][int]$FirstFrame=300,[ValidateRange(1,30)][int]$FrameStep=3,[ValidateSet('02','03')][string]$Study='02',[switch]$ExerciseDistanceStops,[switch]$NoLocalDetours,[switch]$BoundaryAnticipation)
...
if($BoundaryAnticipation){$arguments+='-MikdashCrowdBoundaryAnticipation'}
...
$record.boundaryAnticipation=[bool]$BoundaryAnticipation
