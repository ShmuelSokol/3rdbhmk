    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col gap-3 mb-8">
          ...
          {/* Compare, Pipeline & Export actions */}
          <div className="flex gap-3">
            <button
              onClick={() => router.push(`/book/${bookId}/pipeline`)}
              className="px-4 py-2 rounded-lg bg-[#6366f1] hover:bg-[#4f46e5] text-white text-sm font-medium transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={() => router.push(`/book/${bookId}/crops`)}
              className="px-4 py-2 rounded-lg bg-[#f97316] hover:bg-[#ea580c] text-white text-sm font-medium transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
